...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 4 => ${($_ = isset($this->services['security.authentication.listener.rememberme.main']) ? $this->services['security.authentication.listener.rememberme.main'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_Rememberme_MainService.php')) && false ?: '_'};
