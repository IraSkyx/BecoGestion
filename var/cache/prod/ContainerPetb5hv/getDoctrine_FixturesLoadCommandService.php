...
$a->addFixtures(array(0 => ${($_ = isset($this->services['BGCoreBundle\DataFixtures\ORM\LoadQuote']) ? $this->services['BGCoreBundle\DataFixtures\ORM\LoadQuote'] : $this->services['BGCoreBundle\DataFixtures\ORM\LoadQuote'] = new \BGCoreBundle\DataFixtures\ORM\LoadQuote()) && false ?: '_'}));
