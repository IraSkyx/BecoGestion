...
namespace Proxies\__CG__\BG\CoreBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Customer extends \BG\CoreBundle\Entity\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'id', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'firstName', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'lastName', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'companyName', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'address', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'postcode', '' . "\0" . 'BG\\CoreBundle\\Entity\\Customer' . "\0" . 'city'];
        }
