...
if(args)
{if(args['input'])
{$('.appriseInner').append('<div class="aInput"><input type="text" class="aTextbox" t="aTextbox" /></div>');$('.appriseInner').append('<div class="aErrors"></div>');$('.aTextbox').focus();}}
$('.appriseInner').append('<div class="aButtons"></div>');if(args)
{if(args['confirm']||args['input'])
{$('.aButtons').append('<button class="btn btn-success well" value="ok">Valider</button>');$('.aButtons').append('<button class="btn btn-danger well" id="cancel" value="cancel">Annuler</button>');}
else if(args['verify'])
...
{if($(this).attr("id") == "cancel"){$('.appriseOverlay').remove();$('.appriseOuter').remove();}if(callback)
