...
use BG\QuoteBundle\Repository\BaseServiceRepository;

/**
 * Building
 *
 * @ORM\Table(name="building")
 * @ORM\Entity(repositoryClass="BG\QuoteBundle\Repository\BuildingRepository")
 */
class Building
{
    /**
     ...
     * Add specialService.
     *
     * @param \BG\QuoteBundle\Entity\Service $specialService
     *
     * @return Building
     */
    public function addSpecialService(\BG\QuoteBundle\Entity\Service $specialService)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeSpecialService(\BG\QuoteBundle\Entity\Service $specialService)
    {
